...
function Footer() {
  return (
    <footer className="bg-[#0e334f] text-slate-200">
      <div className="mx-auto grid max-w-[1440px] gap-10 px-5 py-14 sm:grid-cols-2 sm:px-10 lg:grid-cols-[1.55fr_repeat(4,1fr)] lg:gap-8 lg:px-[7vw]">
      ...
      <div className="border-t border-slate-600/70 px-5 py-5 sm:px-10 lg:px-[7vw]"><p className="mx-auto max-w-[1440px] text-sm text-slate-400">&copy; 2026 MechMitra. All rights reserved.</p></div>
    </footer>
  );
}
